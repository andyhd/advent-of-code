...
example_datastream = example_input.strip()


def find(test, stream):
    """
    ...
    >>> find(start_of_packet(), example_datastream)
    7
    ...
    - bvwbjplbgvbhsrlpgdmjqwftvncz: first marker after character 5
      ...
      >>> find(start_of_packet(), 'bvwbjplbgvbhsrlpgdmjqwftvncz')
      5

    - nppdvjthqldpwncqszvftbrmjlhg: first marker after character 6

      >>> find(start_of_packet(), 'nppdvjthqldpwncqszvftbrmjlhg')
      6

    - nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg: first marker after character 10

      >>> find(start_of_packet(), 'nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg')
      10

    - zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw: first marker after character 11

      >>> find(start_of_packet(), 'zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw')
      11
    """
    test.send(None)
    for pos, char in enumerate(iter(stream), start=1):
        if test.send(char):
            return pos


datastream = open("day06-input.txt").read()
...
def part1_answer():
    ...
    marker is detected?
    """
    return find(start_of_packet(), datastream)
...
def start_of_message():
    ...
    - mjqjpqmgbljsphdztnvjfqwrcgsmlb: first marker after character 19
      ...
      >>> find(start_of_message(), 'mjqjpqmgbljsphdztnvjfqwrcgsmlb')
      19

    - bvwbjplbgvbhsrlpgdmjqwftvncz: first marker after character 23

      >>> find(start_of_message(), 'bvwbjplbgvbhsrlpgdmjqwftvncz')
      23

    - nppdvjthqldpwncqszvftbrmjlhg: first marker after character 23

      >>> find(start_of_message(), 'nppdvjthqldpwncqszvftbrmjlhg')
      23

    - nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg: first marker after character 29

      >>> find(start_of_message(), 'nznrnfrfntjfmvfwmzdfjlvtqnbhcprsg')
      29

    - zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw: first marker after character 26

      >>> find(start_of_message(), 'zcfzfwzzqfrljwzlrfnpqdbhtmscgvjw')
      26
    """
    buffer = deque([], maxlen=14)
    while True:
        char = yield len(set(buffer)) == 14
        if char:
            buffer.append(char)
...
def part2_answer():
    ...
    marker is detected?
    """
    return find(start_of_message(), datastream)
